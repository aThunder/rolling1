...
class spCOT():
    ...
    def createSQL(self):
        self.c.execute("DROP TABLE IF EXISTS tbond")

        self.c.execute("CREATE TABLE tbond (ID INTEGER PRIMARY KEY,Date,OpenInt,RptableLong REAL,RptableShort REAL, "
    ...
    def populateSQL(self):
        ...
        for line in self.datax['dataset']['data']:
            ...
            self.c.execute("INSERT OR IGNORE INTO tbond"
